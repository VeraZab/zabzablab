...
export default function AbstractDesignsPage() {
    return (
        <PortfolioPageLayout>
            <script
                ...
                dangerouslySetInnerHTML={{
                    __html: JSON.stringify({
                        ...
                        itemListElement: portfolio.map((item, index) => ({
                            ...
                            position: index + 1,
                            name: item.alt,
                            url: item.href || new URL('/designs/abstract', process.env.NEXT_PUBLIC_SITE_URL || 'https://www.zabzablab.com').toString(),
...
export const metadata: Metadata = {
    ...
    description:
        'Explore whimsical, romantic, and timeless abstract surface pattern designs by ZabZabLab for wallpaper, textiles, and interiors.',
    alternates: {
        canonical: '/designs/abstract',
    },
    openGraph: {
        type: 'website',
        url: '/designs/abstract',
        title: 'Abstract Pattern Designs | ZabZabLab',
        description:
            'Explore whimsical, romantic, and timeless abstract surface pattern designs by ZabZabLab for wallpaper, textiles, and interiors.',
        images: [
            {
