...
export default function FloralDesignsPage() {
    return (
        <PortfolioPageLayout>
            <script
                ...
                dangerouslySetInnerHTML={{
                    __html: JSON.stringify({
                        ...
                        itemListElement: portfolio.map((item, index) => ({
                            ...
                            position: index + 1,
                            name: item.alt,
                            url: item.href || new URL('/designs/floral', process.env.NEXT_PUBLIC_SITE_URL || 'https://www.zabzablab.com').toString(),
...
export const metadata: Metadata = {
    ...
    description:
        'Explore whimsical, romantic, and timeless floral surface pattern designs by ZabZabLab for wallpaper, textiles, and interiors.',
    alternates: {
    ...
    openGraph: {
        type: 'website',
        url: '/designs/floral',
        title: 'Floral Pattern Designs | ZabZabLab',
        description:
            'Explore whimsical, romantic, and timeless floral surface pattern designs by ZabZabLab for wallpaper, textiles, and interiors.',
        images: [
            {
