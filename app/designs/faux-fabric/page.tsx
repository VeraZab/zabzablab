...
const fauxFabricTextures: TextureItem[] = [
    {
        designSrc: '/portfolio/linen-weave-block.jpg',
        alt: 'Tight Linen Weave Texture',
        href: 'https://www.spoonflower.com/collections/1459860-tight-linen-weave-zab26005-by-zabzablab',
        bestFor:
            'Calm living rooms and bedrooms where you want subtle texture instead of a flat painted wall.',
    },
    {
        designSrc: '/portfolio/grasscloth-block.jpg',
        alt: 'Slubby Vertical Grasscloth Texture',
        href: 'https://www.spoonflower.com/collections/1466387',
        bestFor:
            '\u2018Grasscloth look\u2019 feature walls in dining rooms, home offices, and cozy corners\u2014without the cost and delicacy of real grasscloth.',
    },
    {
        designSrc: '/portfolio/diagonal-canvas-block.png',
        alt: 'Diagonal Weave Canvas Texture',
        href: 'https://www.spoonflower.com/collections/1466399',
        bestFor:
            'Accent walls and textiles (pillows, headboards, bench cushions) that need a bit more structure and visual weight.',
    },
    {
        designSrc: '/portfolio/linen2-block.jpg',
        alt: 'Slubby Linen Texture',
        href: 'https://www.spoonflower.com/collections/1462110',
        bestFor:
            'Bedrooms, nurseries, and reading nooks where you want softness and warmth without pattern.',
    },
    {
        designSrc: '/portfolio/basketweave-block3.jpg',
        alt: 'Basketweave Texture',
        href: 'https://www.spoonflower.com/collections/1468931',
        bestFor:
            'Upholstery projects, statement walls, and throw pillows where you want a tactile, woven feel with real visual depth.',
    },
    {
        designSrc: '/portfolio/tweed-block.jpg',
        alt: 'Wool Tweed Texture',
        href: 'https://www.spoonflower.com/collections/1468939',
        bestFor:
            'Moody corners, home offices and reading nooks where you want a warm, cocooning, suiting‑like wall that feels textured and cozy without an obvious pattern.',
    },
]
...
export const metadata: Metadata = {
    ...
    openGraph: {
        ...
        images: [
            {
                url: '/portfolio/linen-weave-block.jpg',
                width: 1200,
                height: 630,
                alt: 'ZabZabLab Faux Fabric Texture Wallpaper',
            },
        ],
    },
    twitter: {
            ...
            <div className={`page-container ${styles.intro}`}>
                ...
                <div className={styles.introLead}>
                    <p className="subheading">
                        A small toolkit of my most-used faux fabric textures for
                        walls and textiles.
                    </p>
                    <p>
                        They&apos;re designed to be a neutral, tactile
                        base&mdash;something that plays well with bold art,
                        vintage finds, or a quiet palette without competing for
                        attention. Each one starts from a real, high-resolution
                        photograph of actual fabric, so the weave, grain, and
                        detail feel authentic.
                    </p>
                </div>
            </div>
                ...
                <div className="page-section-strip-inner">
                    <div className="two-col-grid">
                        ...
                        <div className={`col-body ${styles.twoColBody}`}>
                            <ul>
                                <li>
                                    Available on wallpaper and fabric, and{' '}
                                    <Link href="/resize-recolor-request">
                                        color customizable
                                    </Link>
                                </li>
                                <li>
                                    Easy to clean and maintain compared to real
                                    fabric on walls
                                </li>
                                <li>
                                    A fraction of the cost of real grasscloth or
                                    textile wallcovering
                                </li>
                                <li>
                                    Quick turnaround so you can keep projects
                                    moving
                                </li>
                            </ul>
                        </div>
            ...
            <section className="page-section-strip">
                <div className="page-section-strip-inner">
                    <p className={styles.spoonflowerNote}>
                        If you already use Spoonflower in your projects, these
                        textures are available there as wallpaper and
                        fabric&mdash;easy to order and ready to go.
                    </p>
            ...
            <section className="page-section-strip page-section-strip-alt">
                <div className="page-section-strip-inner">
                    <div className={styles.notFinding}>
                        ...
                        <p>
                            Send me your moodboard or reference pictures at{' '}
                            <a
                            ...
                            ; I&apos;ll pick out 2&ndash;3 textures that fit and
                            send you direct Spoonflower links&mdash;no guesswork
                            on your end.
                        </p>
                        <p>
                            See a texture you like but need an adjustment? Every
                            texture can be color customized to match your
