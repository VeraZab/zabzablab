        ...
        images: [
            {
                ...
                width: 1200,
                height: 630,
                alt: 'ZabZabLab Faux Limewash Texture Wallpaper',
            },
        ],
    },
    twitter: {
        ...
        <main>
            <div className={`page-container ${styles.intro}`}>
                ...
                <div className={styles.introLead}>
                    <p>
                        Soft, plaster-like depth with the look of limewash or
                        mineral paint—without the mess. Ideal for calm,
                        European-inspired walls and spaces that want texture
                        without going bold.
                    </p>
                </div>
            </div>
                ...
                <div className="page-section-strip-inner">
                    <div className={styles.notFinding}>
                        ...
                        <p>
                            ...
                            larger library of limewash and plaster textures that
                            aren&apos;t listed yet.{' '}
                            <a
