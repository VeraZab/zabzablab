            ...
            <script
                ...
                dangerouslySetInnerHTML={{
                    __html: JSON.stringify({
                        ...
                        jobTitle:
                            'Surface Pattern Designer, owner of ZabZabLab Studio',
                    }),
                }}
            />
            <div className={styles.content}>
                <div className={styles.imageContainer}>
                    <img src="/assets/about.jpg" alt="Vera" />
                </div>
                <div className={styles.caption}>
                    <p>
                        Hi, I&apos;m Vera &mdash; the designer behind ZabZabLab.
                        I design wallpaper and fabric for soulful, layered,
                        storied interiors.
                    </p>
                    <p>
                        All my designs are hand-drawn on the iPad. I love mixing
                        traditional motifs with modern elements in thoughtful,
                        unexpected ways &mdash; patterns that feel rooted yet
                        fit the way we actually live today. I hope my work
                        carries a sense of escapism and travel, like a small
                        window into somewhere you&apos;d love to be.
                    </p>
                    <p>
                        My designs are available on wallpaper and fabric through{' '}
                        <a
                        ...
                        , and I offer licensing for commercial projects.
                        I&apos;m based in New Jersey, USA. Have something in
                        mind?{' '}
                        <a href="mailto:zabzablab@gmail.com">Let&apos;s talk</a>
                        !
                    </p>
                </div>
            </div>
